...
with open("relativeplayercoordinates.csv", "w", newline='') as newCoords:
    with open("playercoordinates.csv", "r", newline='') as oldCoords:
        csvWriter = csv.writer(newCoords, delimiter=',')
        csvReader = csv.reader(oldCoords, delimiter=' ', quotechar='|')
